---
id: agent-mission-crafting
version: v1.2.0
description: "任務技術執行與分批次輸出。執行先想好後實行原則、Skill-Acquiring強制查詢、分批次輸出、錯誤收集與CORRECTION.md更新、執行問題標記、交接Finishing。"
author: Kevin Lin
skill_bundle: agent-harness-by-kevinlinz
tags: [mission-crafting, LLM-execution, checklist]
---
