---
id: agent-coordination-mode
version: v1.3.0
description: "任務路由器 + 專家任命者。收到消息後判斷任務類型，簡單任務直接回覆，複雜任務啟動 Mission Pipeline 並任命 Sub-Agent。硬性限制兩層委派，第三層需申請。委任狀由腳本統一生成，產出由腳本統一回收。"
author: Main Agent / 用戶
skill_bundle: agent-harness-engineering
tags: [coordination-mode, router, mission-pipeline, appointment, layer-2]
---
