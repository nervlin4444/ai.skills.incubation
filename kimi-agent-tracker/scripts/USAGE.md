...
完整原始輸出 (2026-05-31, 10/10 passed)：
    ...
    ============================================================
      ...
      [PASS] T7  test_core_path_utils_import: skill_dir={baseDir}
...
完整原始輸出 (2026-05-31, 10/10 passed, exit code 0)：
    ...
    ============================================================
      [PASS] T1  test_get_skill_dir: {baseDir}/config
      [PASS] T2  test_resolve_base_dir: {baseDir}/config/config
      [PASS] T3  test_resolve_home: resolved=~/test_xyz_path, home=~
      [PASS] T4  test_ensure_dir_creates: /var/.../T/kimi_test_ensure_1780229941
      [PASS] T5  test_get_config_dir: {baseDir}/config/config
      [PASS] T6  test_get_data_dir: {baseDir}/config/data
      [PASS] T7  test_get_logs_dir: {baseDir}/config/logs
      [PASS] T8  test_get_download_dir: ~/Downloads
      [PASS] T9  test_get_conversations_json: {baseDir}/config/config/conversations.json
...
完整原始輸出 (2026-05-31, 10/10 passed, exit code 0)：
    ...
    ============================================================
      ...
      [PASS] T4  test_resolve_base_dir: {baseDir}/config/config/test.json
