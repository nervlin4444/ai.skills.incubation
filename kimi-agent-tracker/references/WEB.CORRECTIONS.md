...
description: "Reverse engineering checklist for browser automation. Covers selector detection, DOM diagnosis, iframe/Shadow DOM, click strategies, download handling, and network state management."
version: "v1.0.0"
github_repository: "nervlin4444/ai.skills.incubation"
target_branch: "main"
updated_at: "2026-05-26T01:30:00+08:00"
fixes: []
auth_config:
  provider: "none"
  auth_method: "none"
...
file_mapping:
  ...
  github_path: "kimi-agent-tracker/assets/WEB.CORRECTIONS.md"
---
...
- [ ] **sandbox:// protocol**: Download link uses `sandbox:///mnt/agents/output/...`?
  - Prohibit: Use `expect_download` on sandbox protocol links.
  - Must: `expect_download` timeouts on sandbox links. Use global `page.on('download')` listener instead.
  - Check: If URL starts with `sandbox://`, expect_download will fail. Switch to global listener + manual trigger.
