...
auth_config:
  ...
  env_file_path: .env
file_mapping:
  local_path: "{baseDir}/scripts/jira.query.advanced.py"
  github_path: "jira-restful-api-connector/scripts/jira.query.advanced.py"
---
'''
import json
...
def fetch_milestone_issues_v2(client, milestone_key, other_milestone_keys=None):
    ...
    from jira.query.basic import fetch_issue_by_key
...
def build_changelog_cache(client, epic_key, cache_path):
    ...
    from jira.query.basic import fetch_changelog_by_key
...
def fetch_issue_by_key(client, key, fields="*all"):
    from jira.query.basic import fetch_issue_by_key as _f
